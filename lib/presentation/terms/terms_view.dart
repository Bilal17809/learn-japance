        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              Text('1. Subscription & Billing', style: titleMediumStyle),
              const Gap(kGap),
              Text(
              ...
              Text('2. Free Trial', style: titleMediumStyle),
              const Gap(kGap),
              Text(
              ...
              Text('3. Cancellation & Refunds', style: titleMediumStyle),
              const Gap(kGap),
              Text(
              ...
              Text('4. Changes to Pricing and Terms', style: titleMediumStyle),
              const Gap(kGap),
              Text(
              ...
              Text('5. User Agreement', style: titleMediumStyle),
              const Gap(kGap),
              Text(
